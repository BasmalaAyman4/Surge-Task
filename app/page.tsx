  ...
  return (
    <>
      ...
      <section className="relative py-24 sm:py-32">
        ...
        />
        <div className="absolute inset-0 z-0 bg-gradient-to-t from-[#1a1022] to-transparent" />
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="flex flex-col items-center justify-center gap-6 text-center">
            ...
            <h2 className="max-w-2xl text-base font-normal leading-normal text-gray-300 sm:text-lg">
